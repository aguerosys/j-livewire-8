...
@section('content')
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="text-gray-700 col-span-2">
            ...
            <img src="{{ asset('storage').'/'. $course->image }}" class="">
            ...
            <h2 class="text-xl font-medium my-4">Cursos relacionados</h2>
    ...
    <div class="text-center mt-4">
        ...
        <h2 class="text-xl text-gray-600">Fórmate online como profesional en la industria tecnologica</h2>
